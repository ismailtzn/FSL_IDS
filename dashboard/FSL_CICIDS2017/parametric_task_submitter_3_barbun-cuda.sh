...
#SBATCH -J agent3_torch_experiment     # Gonderilen isin ismi
#SBATCH --dependency singleton
#SBATCH -o experiment_3.out    	# Ciktinin yazilacagi dosya adi
...
cd /truba/home/$USER/agent3/FSL_IDS/dashboard/FSL_CICIDS2017/
