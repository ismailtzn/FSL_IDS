...
if __name__ == '__main__':
    ...
    meta_train_n_way_range = [11]
    meta_train_k_shot_range = [5]
    meta_train_query_count_range = range(5, 16, 5)
    meta_train_max_epoch_range = range(50, 101, 50)
    meta_train_epoch_size_range = range(1000, 5001, 4000)
    dataset_dir_range = ["../../datasets/CIC_IDS_2017/cic_ids_2017_prepared_3-way_test_21-shot"]
    ...
    meta_test_n_way_range = [3]
    meta_test_k_shot_range = [5]
    meta_test_query_count_range = [16]
