...
#SBATCH -J agent4_torch_experiment     # Gonderilen isin ismi
#SBATCH --dependency singleton
#SBATCH -o experiment_4.out    	# Ciktinin yazilacagi dosya adi
...
cd /truba/home/$USER/agent4/FSL_IDS/dashboard/FSL_CICIDS2017/
