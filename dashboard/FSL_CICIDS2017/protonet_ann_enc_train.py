...
def parse_configuration():
    ...
    parser.add_argument("--experiment_dir_prefix", type=str, default="prototypical_ann")
    parser.add_argument("--experiment_time", type=str, default=now)
    parser.add_argument("--meta_train_n_way", type=int, default=8)
    ...
    parser.add_argument("--meta_train_epoch_size", type=int, default=10)
    parser.add_argument("--dataset_dir", type=str, default="../../datasets/CIC_IDS_2017/cic_ids_2017_prepared_4-way10-shot_T8n460q_E4n460q_V12n120q")
    ...
    parser.add_argument("--meta_test_k_shot", type=int, default=20)
    parser.add_argument("--meta_test_query_count", type=int, default=64)
    ...
    parser.add_argument("--early_stop_train_max_acc", type=float, default=0.98)
...
def basic_train_test(config):
    ...
    model = utility.load_protonet_ann(
    ...
    writer.add_graph(model.encoder, torch.rand(1, config.model_x_dim0, config.model_x_dim1).cuda())
    writer.flush()
